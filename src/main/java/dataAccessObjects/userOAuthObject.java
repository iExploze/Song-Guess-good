...
public class userOAuthObject {
    ...
    public String userAuthorizationURL(String clientid, String redirectURL, String scope, String codeVerifier) {
        ...
        String urlLinkWithParams = String.format("https://accounts.spotify.com/authorize?response_type=code&client_id=%s&scope=%s&code_challenge_method=S256" +
